...
const handlePassword=()=>{
  ...
  return (
    <header className="bg-white py-4 pl-72 text-gray-900 flex justify-end lg:justify-between pr-6 lg:pr-0 items-center w-full fixed top-0 z-50">
      <div className="items-center gap-4 relative hidden lg:flex">
        ...
        <div className="md:block" ref={calendarDropdownRef}>
          <button
            className="flex items-center justify-between gap-2 p-2 border border-gray-300 rounded-lg bg-white shadow-sm"
        ...
        <div className="relative flex flex-col" ref={hrTeamDropdownRef}>
          ...
          >            <HiMiniUsers size={20} />
            <span className="hidden md:inline">HR Team</span>
            <HiOutlineChevronDown size={16} />
          </button>
      ...
      <div className="relative flex items-center gap-x-4 lg:gap-x-8 pr-0 sm:pr-2 lg:pr-8">
        ...
        <div className="relative lg:w-80 w-52">
          <input
            type="text"
        ...
        <button className="items-center hidden md:flex bg-white shadow-md hover:bg-[#022213] hover:text-[#72B800] p-2 rounded-lg -mr-2">
          <FaBell size={20} />
        </button>
        <button
          className="items-center hidden md:flex shadow-md hover:bg-[#022213] hover:text-[#72B800] p-2 rounded-lg"
